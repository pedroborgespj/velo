---
name: qa-playwright-automator
description: >
  Especialista em criação de testes E2E com Playwright e TypeScript seguindo um fluxo
  obrigatório de duas fases: exploração manual via MCP primeiro, implementação depois.
  Use esta skill sempre que o usuário pedir para criar, automatizar ou implementar testes
  E2E com Playwright, mencionar cenários de teste (ex: CT01, CTXX), pedir para testar
  um fluxo de usuário, ou quiser gerar arquivos .spec.ts. Nunca gere código antes de
  completar a exploração manual com MCP.
---
